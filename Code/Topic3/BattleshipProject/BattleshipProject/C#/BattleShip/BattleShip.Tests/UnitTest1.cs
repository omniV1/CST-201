...
namespace BattleShip.Tests
{
    public class Tests
    {
        ...
        public void TestDestroyerPlacement()
        {
            ...
            destroyer.Left = true;
            placed = game.PlaceDestroyer(game.PlayerBoard, 4, 3, destroyer);
            Assert.Multiple(() =>
            {
                Assert.That(placed, Is.True);
                Assert.That('O', Is.EqualTo(game.PlayerBoard[4, 2]));
                ...
                Assert.That('O', Is.EqualTo(game.PlayerBoard[5, 3]));
            });
            ...
            destroyer.Left = true;
            placed = game.PlaceDestroyer(game.PlayerBoard, 7, 4, destroyer);
            Assert.Multiple(() =>
            {
                Assert.That(placed, Is.True);
                Assert.That('O', Is.EqualTo(game.PlayerBoard[6, 3]));
